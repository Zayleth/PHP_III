        ...
        <div class="row py-5">
            <form action="actions.php" class="col-md-9 m-auto" method="post" role="form">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control mt-1" id="subject" name="subject" placeholder="Password">
                </div>

                <input type="hidden" class="form-control mt-1" id="subject" name="oculto" value="1">
