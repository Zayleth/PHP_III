...
<body>
    ...
    <?php
        ...
        // funcionalidad: imagenes del producto (uno solo en especifico)
		include "connection.php";
        // extraemos el id en base a shop.php - WHERE id_products = $_GET[indice]
		$sql="SELECT * FROM products WHERE id_products = '$_GET[indice]'";
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="h3 py-2"><?php echo number_format($row[4], 2, ",",".");?></p>
                            <p class="py-2">
                            ...
                            <!-- NECESITAMOS 2 INPUT TIPO HIDDEN PARA OBTENER 
                            EL ID PARA CUANDO SE APRIETE EL BOTON DEL CARRITO 
                            DE COMPRAS, LLEVE ESA INFO-->
